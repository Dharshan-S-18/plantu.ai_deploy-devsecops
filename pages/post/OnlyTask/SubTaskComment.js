...
const CommentSection = ({ workspaceId, projectId, taskId, subtaskId, onCommentsChange }) => {
                    ...
                    <Box key={index} sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
                        ...
                        <Box>
                            <Typography variant="body2" sx={{ fontWeight: '600' }}>
                                {comment.user || 'Unknown User'} {comment.timestamp ? new Date(comment.timestamp).toLocaleString() : ''}
                            </Typography>
